...
class GrooscriptConverter {
    ...
    ConvertedCode convertCode(String groovyCode) {
        ...
        File grooscriptJsFile = new File(FILE_NAME)
        grooscriptJsFile.text = GROOSCRIPT_JS_1 + GROOSCRIPT_JS_2
        try {
            ...
            JsTestResult result = JavascriptEngine.jsEval(finalJsCode, null, grooscriptJsFile)
    ...
    private static final FILE_NAME = '_grooscript.js'
    private static final GROOSCRIPT_JS_1 = '''
(function() {
    var gs = function(obj) {
...
'''
    ...
    private static final GROOSCRIPT_JS_2 = '''
    /////////////////////////////////////////////////////////////////
    //list - [] from groovy
    /////////////////////////////////////////////////////////////////
